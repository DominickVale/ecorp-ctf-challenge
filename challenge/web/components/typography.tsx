...
export function H1({ className, small, smaller, ...props }: H1Props) {
  return (
    <h1
      className={cn(
        "font-heading text-[clamp(1.5rem,8.054vw,3.4rem)] lg:text-xl xl:text-[clamp(3.4rem,7vw,6.854rem)] 4xl:text-[clamp(6.854rem,4vw,11.09rem)] leading-[1.18] tracking-display text-black",
...
export function H2({ className, small, ...props }: H1Props) {
  return (
    <h2
      className={cn(
        "font-heading text-[clamp(1.5rem,8.5vw,2.3rem)] leading-[1.18] tracking-display text-background-light 2xl:text-[clamp(4.4rem,3vw,7.09rem)]",
