...
export function H1({ className, small, smaller, ...props }: H1Props) {
  return (
    <h1
      className={cn(
        "font-heading text-[clamp(1.5rem,8.054vw,3.4rem)] lg:text-xl xl:text-[clamp(3.4rem,5.8vw,9.054rem)] 4xl:text-[clamp(6.854rem,4vw,11.09rem)] leading-[1.18] tracking-display text-black",
