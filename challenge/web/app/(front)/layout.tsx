    ...
    <html lang="en">
      ...
      >
        ...
        <section className="absolute left-0 top-0 hidden h-full w-20 md:block">
          <div className="sticky top-0 h-[100vh] lg:h-[calc(100vh-57px)] overflow-hidden">
            <span className="flex h-full flex-col place-items-center justify-around lg:py-8 lg:pt-16 pt-16 text-[1.2vh] taller:text-xs taller:2xl:text-smaller">
              <p className="rotate-marquee h-max tracking-display">
                ⋅&nbsp;&nbsp;14/02/2030 -30% DISCOUNT FOR NEWCOMERS
              </p>
            </span>
          </div>
        </section>
