...
export default function PostLayout(props: Props) {
    ...
    return (
        <>
            <main className="relative mt-[-2.4rem] grid-cols-golden grid-rows-golden bg-white pt-8 md:mt-0 md:pt-0 lg:grid">
                <GoldenLayoutLines className="z-10" />
                <section className="row-span-3 px-4 pb-40 lg:ml-12 xl:mx-12 2xl:mx-40">
                    <div className="absolute left-1 top-16 md:top-8 lg:top-2">
                        <div className="mb-5 font-medium text-gray-500">
                            ...
                            <div className="absolute left-2 top-[-1.5rem] lg:top-[-2.1rem]">
                                ...
                                <Date
                                    dateString={date}
                                    className="ml-4 text-xs text-background-dark"
                                />
                            </div>
                    ...
                    <MDXRemote
                        components={{
                            ...
                            h3: (p) => (
                                <h3
                                    {...p}
                                    className="mb-2 mt-6 text-sm font-bold 2xl:mt-12 2xl:text-lg"
                                />
                            ),
                            p: (p) => (
                                <p
                                    {...p}
                                    className="mb-2 text-sm text-stone-700 2xl:text-md 3xl:text-base"
                                />
                            ),
                        }}
                        {...mdxSource}
                ...
                <section className="col-span-2 col-start-2 row-span-3 row-start-1 bg-background-light px-4 pt-28 transition-opacity duration-200 hover:opacity-100 lg:px-20 lg:opacity-50">
