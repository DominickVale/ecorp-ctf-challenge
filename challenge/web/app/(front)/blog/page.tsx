...
export default async function Blog() {
    ...
    return (
        <>
            <main className="relative flex min-h-screen grid-cols-2 grid-rows-[1fr_0.75fr_0.3fr] flex-col flex-wrap md:grid lg:grid-cols-golden lg:grid-rows-golden h-screen">
                <GoldenLayoutLines />
                ...
                <section className="self-start row-start-2 mx-1 mb-16 mt-8 bg-background-light px-4 pt-12 md:pt-28 lg:col-span-2 lg:col-start-2 lg:row-start-2 lg:mb-0 lg:px-12 lg:pt-0 xl:px-20">
                    <h3 className="mb-12 font-heading text-base font-bold tracking-wide text-background-dark">
                        SOFTWARE \\
                        <br />
                        CHANGELOGS
